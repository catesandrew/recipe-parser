...
var RecipeParser = module.exports = Backbone.Model.extend({
  ...
  getAllPieces: function(text) {
    ...
    var descriptionObj = this.getDescriptions(text), // isOrSplit, descriptions, matchedDescriptions, parentheses, direction
        descriptions = descriptionObj.descriptions;
    ...
    // we are done
    return {
      quantities: quantities, // now is an array
      measurements: measurements,
      descriptionObj: descriptionObj,  // already has an array of descriptions
      directions: directions          // already an array
    };
  },
