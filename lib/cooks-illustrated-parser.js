...
var _words = [
  'chopped', 'cracked', 'finely', 'fresh',  'grated', 'ground', 'hard-cooked', 'minced', 'ripe', 'shredded', 'toasted'
];
...
var commaSplitterRe = /,/;
var splitComma = _.bind(splitOnRegex, exports, commaSplitterRe);
var andSplitterRe = /(?:\s+)?\band\s+/i;
var splitAnd = _.bind(splitOnRegex, exports, andSplitterRe);
var orSplitterRe = /(?:\s+)?\bor\s+/i;
var splitOr = _.bind(splitOnRegex, exports, orSplitterRe);
...
var getDescriptions = parser.getDescriptions = function(text) {
  ...
  descriptions = _.map(descriptions, function(desc) {
    tmp = (chopWordsFromFront(desc, _words, 3) || {});
